  ...
  <div id="app">
    ...
    <div class="md-layout">
      <div class="md-layout-item">
        <div class="video-vtn">
          <video autoplay="autoplay" :srcObject.prop="stream1" ref="videoStream" playsinline width="640px"
            height="480px"></video>
      ...
      <div class="md-layout-item">
        <div class="video-vtn">
          <video autoplay="autoplay" :srcObject.prop="stream2" ref="videoStream" playsinline width="640px"
            height="480px"></video>
          <!-- <video v-if="attach.remote.stream != null && attach.message.status == 'started'" id="player"
          :srcObject.prop="attach.remote.stream" playsinline autoplay loop></video> -->
          <div v-if="!stream2">No Stream</div>
          <div>Status: {{ status2 ? status2 : "No video stream" }}</div>
